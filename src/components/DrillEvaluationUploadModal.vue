  ...
  <div v-if="visible" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
      ...
      <div class="flex justify-between items-center pb-3 border-b">
        <h3 class="text-xl font-bold text-gray-900">上传评估总结</h3>
      ...
      <!-- 演练信息 -->
      <div v-if="evaluationData" class="mt-4 bg-blue-50 rounded-lg p-4">
        <h4 class="text-sm font-medium text-blue-900 mb-2">演练信息</h4>
...
const handleUpload = async () => {
  ...
  try {
    ...
    const response = await request.post(
      `/drill-evaluations/${props.evaluationData.executionId}/reports`,
      formData,
      {
        headers: {
